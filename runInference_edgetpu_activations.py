...
class evalSession():
    ...
    def __init__(self, model_name, session_name="evalSession", generated_inputs=1e4):
        ...
        self.input_size = 32
        # self.model_float_ops = self.input_size*self.input_size # just the matrix multiplications
        self.model_float_ops = 1 # for now
...
if __name__=="__main__":
    ...
    for i in ['linear','relu','softmax','sigmoid','tanh']:
        model_names.append("activation_" + str(i) )
